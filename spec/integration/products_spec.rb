      ...
      response 200, "product found" do
        ...
        schema type: :object,
          properties: {
            ...
            ipi: { type: :number, example: Faker::Number.decimal(l_digits: 2) },
            barcode: { type: :string, example: "7894916512510" },
            reduction: { type: :number, example: Faker::Number.decimal(l_digits: 2) },
            weight: { type: :number, example: Faker::Number.decimal(l_digits: 2) },
            height: { type: :number, example: Faker::Number.decimal(l_digits: 2) },
            width: { type: :number, example: Faker::Number.decimal(l_digits: 2) },
            length: { type: :number, example: Faker::Number.decimal(l_digits: 2) },
    ...
    post "Creates a product" do
      ...
      parameter name: :product, in: :body, schema: {
                  ...
                  properties: {
                    name: { type: :string, example: Faker::Commerce.product_name },
                    description: { type: :string, example: Faker::Commerce.material },
                    ipi: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    barcode: { type: :string, example: "7894916512510" },
                    reduction: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    weight: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    height: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    width: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    length: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    kind: { type: :string, example: "third_party", description: "pode ser own, third_party ou not_marketed" },
    ...
    put "Updates a product" do
      ...
      parameter name: :product, in: :body, schema: {
                  ...
                  properties: {
                    ...
                    name: { type: :string, example: Faker::Commerce.product_name },
                    description: { type: :string, example: Faker::Commerce.material },
                    ipi: { type: :float, example: Faker::Number.decimal(l_digits: 2) },
                    color: { type: :string, example: Faker::Color.hex_color },
                    barcode: { type: :string, example: "7894916512510" },
                    reduction: { type: :string, example: Faker::Number.decimal(l_digits: 2) },
                    weight: { type: :float, example: Faker::Number.decimal(l_digits: 2) },
                    height: { type: :float, example: Faker::Number.decimal(l_digits: 2) },
                    width: { type: :float, example: Faker::Number.decimal(l_digits: 2) },
                    length: { type: :float, example: Faker::Number.decimal(l_digits: 2) },
                    kind: { type: :string, example: "third_party", description: "pode ser own, third_party ou not_marketed" },
                    active: { type: :string, example: true },
                    unit_id: { type: :integer, example: 11 },
                    sku: { type: :string, example: "123456" },
