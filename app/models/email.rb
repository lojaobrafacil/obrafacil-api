class Email < ApplicationRecord
  ...
  validates_uniqueness_of :primary, scope: [:emailable_id, :emailable_type], message: I18n.t("activerecord.models.errors.email.attributes.primary"), if: Proc.new { |email| Email.primary(emailable_id: email.emailable_id, emailable_type: email.emailable_type, id: email.id).size > 0 }
