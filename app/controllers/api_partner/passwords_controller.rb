  ...
  def forgot_password
    ...
    if @partner
      if @partner.primary_email
        ...
        render json: { success: "Enviei um email para #{@partner.primary_email.email} com as instruçōes necessaria. caso não receba o email entre em contato conosco t: (11) 3031-6891." }, status: 200
      else
