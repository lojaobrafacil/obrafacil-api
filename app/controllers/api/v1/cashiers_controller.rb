class Api::V1::CashiersController < Api::V1::BaseController
  ...
  def cashier_params
    params.require(:cashier).permit(:start_date, :finish_date, :employee, :active, :cashier_payment_attributes => [:payment_method_id, :value, :_destroy])
  end
end
